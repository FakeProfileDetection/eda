...
if __name__ == "__main__":
    ...
    for imp_path in ['imputation_global', 'imputation_user']:
        ...
        for file, level in zip(['dataset_1_full.csv', 'dataset_2_full.csv', 'dataset_3_full.csv'], ['platform_id', 'session_id', 'video_id']):
            ...
            save_file_path = os.path.join(dpath, file.replace('.csv', '_IL_filtred.csv'))
